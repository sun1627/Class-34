...
function setup() 
{
  ...
  star1.addImage("star",star);
  star2.addImage("star",star);
  star1.scale = 0.02;
  star2.scale = 0.02;

  star_display = createSprite(50,20,30,30);
  star_display.scale = 0.2;
  star_display.addAnimation("empty",empty);
...
function draw() 
{
  ...
  if (collide(fruit,star1,20)=== true) {
    star1.visible = false;
    star_display.changeAnimation("one_star",one_star);
  }

  if (collide(fruit,star2,20)=== true) {
    star2.visible = false;
    star_display.changeAnimation("two_star",two_star);
  }
}
